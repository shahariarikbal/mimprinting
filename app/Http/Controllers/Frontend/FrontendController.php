...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.home.index', compact('services', 'projects', 'feedbacks'));
    }
    ...
    public function showTermsConditions(){
        return view('frontend.setting.terms-conditions');
    }
    ...
    public function showPaymentPolicy(){
        return view('frontend.setting.payment-policy');
    }
